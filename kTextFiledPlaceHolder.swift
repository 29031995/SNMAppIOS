...
class kTextFiledPlaceHolder: UITextField {
    ...
    func EnableMaterialPlaceHolder(enableMaterialPlaceHolder: Bool){
        ...
        self.lblPlaceHolder.frame = CGRect(x: 20, y : 0, width : 0, height :self.frame.size.height)
        self.lblPlaceHolder.font = UIFont.systemFont(ofSize: 8)
